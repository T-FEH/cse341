...
// The ids are fixed so the examples in the Swagger docs keep working
// after a reseed.
const { ObjectId } = require('mongodb');
const { initDb, getDatabase } = require('./db/connect');

const chefs = [
  { _id: new ObjectId('000000000000000000000c01'), firstName: 'Marco', lastName: 'Bellini', email: 'marco.bellini@example.com',
    specialty: 'Northern Italian', yearsExperience: 18,
    bio: 'Trained in Bologna and spent a decade making fresh pasta by hand.' },
  { _id: new ObjectId('000000000000000000000c02'), firstName: 'Amara', lastName: 'Okafor', email: 'amara.okafor@example.com',
    specialty: 'West African', yearsExperience: 12,
    bio: 'Grew up cooking in Lagos and now teaches jollof technique worldwide.' },
  { _id: new ObjectId('000000000000000000000c03'), firstName: 'Yuki', lastName: 'Tanaka', email: 'yuki.tanaka@example.com',
  ...
  { _id: new ObjectId('000000000000000000000c04'), firstName: 'Sofia', lastName: 'Reyes', email: 'sofia.reyes@example.com',
    specialty: 'Mexican', yearsExperience: 15,
    bio: 'Specialises in slow-cooked moles that take three days to build.' },
  { _id: new ObjectId('000000000000000000000c05'), firstName: 'Tife', lastName: 'Alewi', email: 'tife.alewi@example.com',
    specialty: 'Baking and pastry', yearsExperience: 4,
    bio: 'Learned to bake during university and has not stopped since then.' },
  { _id: new ObjectId('000000000000000000000c06'), firstName: 'Priya', lastName: 'Raman', email: 'priya.raman@example.com',
    specialty: 'South Indian', yearsExperience: 7,
    bio: 'Makes dosa batter from scratch and ferments it for two full days.' }
];

// chefIndex points at the chefs list above
const recipes = [
  { _id: new ObjectId('000000000000000000000a01'), chefIndex: 0, title: 'Spaghetti Carbonara', description: 'A Roman pasta dish built on eggs, cheese and cured pork.',
  ...
  { _id: new ObjectId('000000000000000000000a02'), chefIndex: 0, title: 'Risotto alla Milanese', description: 'A slow-stirred saffron risotto from Milan.',
  ...
  { _id: new ObjectId('000000000000000000000a03'), chefIndex: 1, title: 'Jollof Rice', description: 'Smoky West African rice simmered in a rich pepper base.',
  ...
  { _id: new ObjectId('000000000000000000000a04'), chefIndex: 1, title: 'Suya Skewers', description: 'Grilled beef skewers coated in a spiced peanut rub.',
  ...
  { _id: new ObjectId('000000000000000000000a05'), chefIndex: 2, title: 'Miso Soup', description: 'A simple dashi broth finished with miso paste and tofu.',
  ...
  { _id: new ObjectId('000000000000000000000a06'), chefIndex: 2, title: 'Chicken Katsu', description: 'Panko-crusted chicken cutlet fried until deeply golden.',
  ...
  { _id: new ObjectId('000000000000000000000a07'), chefIndex: 3, title: 'Chicken Tinga Tacos', description: 'Shredded chicken in a smoky chipotle tomato sauce.',
  ...
  { _id: new ObjectId('000000000000000000000a08'), chefIndex: 4, title: 'Brown Butter Chocolate Chip Cookies', description: 'Chewy cookies with nutty depth from browned butter.',
...
const run = async () => {
  ...
  // Swap chefIndex for the real chef id
  ...
  for (let i = 0; i < recipes.length; i++) {
    ...
    recipesToInsert.push({
      ...
      chefId: chefs[recipe.chefIndex]._id.toString()
    });
  }
  ...
  console.log('');
  console.log('Priya (chef c06) has no recipes, so she can be deleted in a demo.');
  process.exit(0);
};
